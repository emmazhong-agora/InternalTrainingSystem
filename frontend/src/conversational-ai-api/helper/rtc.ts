// NOTE: agora-conversational-ai-denoiser is optional - commenting out for now
// import {
//   AIDenoiserExtension,
...
// Stub for denoiser types
type AIDenoiserProcessorLevel = 'AGGRESSIVE' | 'MODERATE' | 'LIGHT'
...
> {
  ...
  public async initDenoiserProcessor(
    ...
    // AI Denoiser is optional and requires 'agora-conversational-ai-denoiser' package
    console.warn('[DenoiserProcessor]', 'AI Denoiser not available - package not installed')
    return
