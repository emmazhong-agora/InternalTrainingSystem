...
const logger = {
  info: (...args: any[]) => console.log('[MessageHelper]', ...args),
  warn: (...args: any[]) => console.warn('[MessageHelper]', ...args),
  error: (...args: any[]) => console.error('[MessageHelper]', ...args),
  debug: (...args: any[]) => {}, // No-op for debug to reduce noise
}

// Decode stream message utility
const decodeStreamMessage = (stream: Uint8Array): string => {
